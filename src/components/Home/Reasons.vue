    ...
    <div class="container">
      ...
      <div class="grid">
        <List title="Каждый день свежий привоз">
          Перед отправкой продукты проходят наш внутренний осмотр на свежесть
          лучшими микробиологами стран СНГ!
        </List>

        <List title="У нас лучшие логисты">
          Одна из наш прерогатив - это доставлять товары в назначенное время.
          Интересный факт: 19 из 20 доставок осуществляются в обговоренный срок
          вплоть до минуты!
        </List>
